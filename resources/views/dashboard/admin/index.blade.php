                ...
                <div class="col-xl-3 col-md-6">
                    <div
                        ...
                        <div>
                            ...
                            <div class="lh-1 mt-25">
                                <span class="text-purple-1">40+</span> New Courses
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div
                        ...
                        <div>
                            ...
                            <div class="lh-1 mt-25">
                                <span class="text-purple-1">90+</span> New Students
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div
                        ...
                        <div>
                            ...
                            <div class="lh-1 mt-25">
                                <span class="text-purple-1">290+</span> New
                                Instructors
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-between items-center py-20 px-30 border-bottom-light">
                            ...
                            <div class="">
                                <div class="dropdown js-dropdown js-category-active">
                                    <div class="dropdown__button d-flex items-center text-14 bg-white -dark-bg-dark-1 border-light rounded-8 px-20 py-10 text-14 lh-12"
                                    ...
                                    <div
                                        ...
                                        <div class="text-14 y-gap-15 js-dropdown-list">
                                            ...
                                            <div>
                                                <a href="#" class="d-block js-dropdown-link">Illustration</a>
                                            </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                        ...
                        <div class="py-30 px-30">
                            <div class="y-gap-40">
                                <div class="d-flex">
                                    <img class="size-40" src="{{ asset('assets/img/dashboard/avatars/1.png') }}"
                                        alt="avatar" />
                    ...
                    <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                        ...
                        <div class="py-30 px-30">
                            <div class="y-gap-40">
                                <div class="d-flex">
                                    <div class="shrink-0">
                                        <img src="{{ asset('assets/img/dashboard/recent-courses/1.png') }}"
                                            alt="image" />
                                    </div>
                                    <div class="ml-15">
                                        ...
                                        <div class="d-flex items-center x-gap-20 y-gap-10 flex-wrap pt-10">
                                            <div class="d-flex items-center">
                                                <img class="size-16 object-cover mr-8"
                                                    src="{{ asset('assets/img/general/avatar-1.png') }}" alt="icon" />
