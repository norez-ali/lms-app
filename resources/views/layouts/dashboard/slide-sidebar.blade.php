          ...
          <div class="relative js-menu-switch">
                          ...
                          <div class="accordion__content">
                              <div class="accordion__content__inner pl-20 pr-20 pb-20">
                                  <div data-sidebar-menu-target="messages-2" class="row x-gap-10 y-gap-10 pointer">
                                      <div class="col-auto">
                                          <img src="{{ asset('assets/img/dashboard/right-sidebar/messages/1.png') }}"
                                              alt="image" />
                                      </div>
                                      <div class="col">
                                          ...
                                          <div class="text-14 lh-1 mt-5">
                                              <span class="text-dark-1">You:</span> Hello
                                          </div>
                                      </div>
                                      <div class="col-auto">
              ...
              <div data-sidebar-menu-open="messages-2" class="sidebar-menu__item -sidebar-menu">
                  <div class="row x-gap-10 y-gap-10">
                      <div class="col-auto">
                          <img src="{{ asset('assets/img/dashboard/right-sidebar/messages-2/1.png') }}"
                              alt="image" />
                      </div>
                      <div class="col">
                          <div class="text-15 lh-12 fw-500 text-dark-1 pt-8">
                      ...
                      <div class="row y-gap-20">
                          <div class="col-12">
                              <div class="row x-gap-10 y-gap-10 items-center">
                                  <div class="col-auto">
                                      <img src="{{ asset('assets/img/dashboard/right-sidebar/messages-2/2.png') }}"
                                          alt="image" />
                                  </div>
                                  <div class="col-auto">
                          ...
                          <div class="col-12">
                              <div class="row x-gap-10 y-gap-10 items-center justify-end">
                                  ...
                                  <div class="col-auto">
                                      <img src="{{ asset('assets/img/dashboard/right-sidebar/messages-2/3.png') }}"
                                          alt="image" />
                                  </div>
                              </div>
                              <div
                  ...
                  <div class="tabs -pills js-tabs">
                      ...
                      <div class="tabs__content pt-30 js-tabs-content">
                          <div class="tabs__pane -tab-item-1 is-active">
                              <div class="row x-gap-10 y-gap-10 items-center">
                                  <div class="col-auto">
                                      <img src="{{ asset('assets/img/dashboard/right-sidebar/contacts/1.png') }}"
                                          alt="image" />
                                  </div>
                                  <div class="col-auto">
                                      <div class="text-15 lh-12 fw-500 text-dark-1">
              ...
              <div data-sidebar-menu-open="settings" class="sidebar-menu__item -sidebar-menu">
                  ...
                  <div class="form-switch d-flex items-center">
                      ...
                      <div class="text-13 lh-1 text-dark-1 ml-10">
                          Use enter to send
                      </div>
                  </div>
              </div>
