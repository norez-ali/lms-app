                                ...
                                <div class="text-white d-flex items-center lg:d-none mr-15">
                                    ...
                                    <div class="relative">
                                        <a href="#" class="d-flex items-center text-dark-1 ml-20"
                                            ...
                                            My Courses
                                            <i class="text-9 icon-chevron-down ml-10"></i>
                                        </a>
                                            ...
                                            <div
                                                ...
                                                <div class="px-30 py-30">
                                                    <div class="d-flex mb-20">
                                                        <img class="size-80 fit-cover"
                                                            src="{{ asset('assets/img/menus/cart/1.png') }}"
                                                            alt="image" />

                                                        <div class="ml-15">
                                                            <div class="text-dark-1 lh-15 fw-500">
                                                    ...
                                                    <div class="d-flex mb-20">
                                                        <img class="size-80 fit-cover"
                                                            src="{{ asset('assets/img/menus/cart/2.png') }}"
                                                            alt="image" />
                                                    ...
                                                    <div class="mt-20">
                                                        <a href="#"
                                                            class="button py-20 -dark-1 text-white -dark-bg-purple-1 -dark-border-dark-2 col-12">Go
                                                            to My Learning</a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row justify-between x-gap-40 pb-20">
                                                        <div class="col">
                                                            <div class="row x-gap-10 y-gap-10">
                                                                ...
                                                                <div class="col">
                                                                    <div class="text-dark-1 lh-15">
                                                                        User Experience Design Essentials - Adobe
                                                                        XD UI UX...
                                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div class="py-30 px-30">
                                                    <div class="y-gap-40">
                                                        <div class="d-flex items-center">
                                                            <div class="shrink-0">
                                                                <img src="{{ asset('assets/img/dashboard/actions/1.png') }}"
                                                                    alt="image" />
                                                            </div>
                                                            <div class="ml-12">
                                                        ...
                                                        <div class="d-flex items-center border-top-light">
                                                            <div class="shrink-0">
                                                                <img src="{{ asset('assets/img/dashboard/actions/2.png') }}"
                                                                    alt="image" />
                                                            </div>
                                                            <div class="ml-12">
                                                                <h4 class="text-15 lh-1 fw-500">
                                                        ...
                                                        <div class="d-flex items-center border-top-light">
                                                            <div class="shrink-0">
                                                                <img src="{{ asset('assets/img/dashboard/actions/3.png') }}"
                                                                    alt="image" />
                                                            </div>
                                                            <div class="ml-12">
                                                                <h4 class="text-15 lh-1 fw-500">
                                                        ...
                                                        <div class="d-flex items-center border-top-light">
                                                            <div class="shrink-0">
                                                                <img src="{{ asset('assets/img/dashboard/actions/4.png') }}"
                                                                    alt="image" />
                                                            </div>
                                                            <div class="ml-12">
                                                                <h4 class="text-15 lh-1 fw-500">
                                                        ...
                                                        <div class="d-flex items-center border-top-light">
                                                            <div class="shrink-0">
                                                                <img src="{{ asset('assets/img/dashboard/actions/5.png') }}"
                                                                    alt="image" />
                                                            </div>
                                                            <div class="ml-12">
                                                                <h4 class="text-15 lh-1 fw-500">
