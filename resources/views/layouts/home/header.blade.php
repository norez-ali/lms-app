                                                ...
                                                <div class="row x-gap-40">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <ul class="mega__list">
                                                            ...
                                                            <li><a data-barba href="dshb-courses.html">My Courses</a>
                                                            </li>

                                                            <li><a data-barba href="dshb-bookmarks.html">Bookmarks</a>
                                                            </li>

                                                            <li><a data-barba href="dshb-listing.html">Add Listing</a>
                                                            </li>

                                                            <li><a data-barba href="dshb-reviews.html">Reviews</a></li>

                                                            <li><a data-barba href="dshb-settings.html">Settings</a>
                                                            </li>
                                                            ...
                                                            <li><a data-barba href="dshb-calendar.html">Calendar</a>
                                                            </li>
                                                            ...
                                                            <li><a data-barba href="dshb-messages.html">Messages</a>
                                                            </li>
                                        ...
                                        <ul class="subnav d-none xl:d-block">
                                            ...
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="subnav">
                                                    <li class="menu__backButton js-nav-list-back">
                                                        <a href="#"><i
                                                                class="icon-chevron-left text-13 mr-10"></i> Dashboard
                                                            Pages</a>
                                                    </li>
                                            ...
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="subnav">
                                                    <li class="menu__backButton js-nav-list-back">
                                                        <a href="#"><i
                                                                class="icon-chevron-left text-13 mr-10"></i> Popular
                                                            Courses</a>
                                                    </li>
                                        ...
                                        <ul class="subnav">
                                            ...
                                            <li class="menu-item-has-children">
                                                ...
                                                <ul class="subnav">
                                                    <li class="menu__backButton js-nav-list-back">
                                                        <a href="#"><i
                                                                class="icon-chevron-left text-13 mr-10"></i> Shop</a>
                                                    </li>
